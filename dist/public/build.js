...
},{"./vue.common.dev.js":5,"./vue.common.prod.js":7,"_process":1}],7:[function(require,module,exports){
(function (global,setImmediate){(function (){
/*!
 * Vue.js v2.6.8
 * (c) 2014-2019 Evan You
...
exports.default = {
  ...
  created: async function created() {
    var response = await fetch('/api/movies/' + this.$route.params.id);
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container mx-auto p-4"},[_c('router-link',{staticClass:"text-blue-500 mb-4 inline-block",attrs:{"to":"/"}},[_vm._v("← Back to List")]),_vm._v(" "),(_vm.movie)?_c('div',{staticClass:"border p-4 rounded"},[_c('h1',{staticClass:"text-2xl font-bold"},[_vm._v(_vm._s(_vm.movie.title))]),_vm._v(" "),_c('p',[_c('strong',[_vm._v("Original Title:")]),_vm._v(" "+_vm._s(_vm.movie.original_title))]),_vm._v(" "),_c('p',[_c('strong',[_vm._v("Overview:")]),_vm._v(" "+_vm._s(_vm.movie.overview))]),_vm._v(" "),_c('p',[_c('strong',[_vm._v("Release Date:")]),_vm._v(" "+_vm._s(new Date(_vm.movie.release_date).toLocaleDateString()))]),_vm._v(" "),_c('p',[_c('strong',[_vm._v("Runtime:")]),_vm._v(" "+_vm._s(_vm.movie.runtime)+" minutes")]),_vm._v(" "),_c('p',[_c('strong',[_vm._v("Status:")]),_vm._v(" "+_vm._s(_vm.movie.status))]),_vm._v(" "),_c('p',[_c('strong',[_vm._v("Tagline:")]),_vm._v(" "+_vm._s(_vm.movie.tagline))]),_vm._v(" "),_c('p',[_c('strong',[_vm._v("Rating:")]),_vm._v(" "+_vm._s(_vm.movie.vote_average)+"/10")]),_vm._v(" "),_c('p',[_c('strong',[_vm._v("Votes:")]),_vm._v(" "+_vm._s(_vm.movie.vote_count))])]):_vm._e()],1)}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-33225414"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-33225414", __vue__options__)
  } else {
    hotAPI.reload("data-v-33225414", __vue__options__)
  }
})()}
},{"vue":9,"vue-hot-reload-api":3}],12:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container mx-auto p-4"},[_c('h1',{staticClass:"text-2xl font-bold mb-4"},[_vm._v("Movies")]),_vm._v(" "),_c('div',{staticClass:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4"},_vm._l((_vm.movies),function(movie){return _c('div',{key:movie.id,staticClass:"border p-4 rounded"},[_c('h2',{staticClass:"text-xl font-semibold"},[_vm._v(_vm._s(movie.title))]),_vm._v(" "),_c('p',[_vm._v(_vm._s(movie.tagline))]),_vm._v(" "),_c('p',[_vm._v("Rating: "+_vm._s(movie.vote_average)+"/10")]),_vm._v(" "),_c('button',{attrs:{"type":"button"}},[_vm._v("Hello")]),_vm._v(" "),_c('router-link',{staticClass:"text-blue-500",attrs:{"to":'/movie/' + movie.id}},[_vm._v("Details")])],1)}),0)])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-27f801fa"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-27f801fa", __vue__options__)
  } else {
    hotAPI.reload("data-v-27f801fa", __vue__options__)
  }
})()}
...
},{"./router":14,"vue-router":4,"vue/dist/vue.common":6}],14:[function(require,module,exports){
'use strict';
...
var _MovieList = require('../components/MovieList.vue');

var _MovieList2 = _interopRequireDefault(_MovieList);

var _MovieDetail = require('../components/MovieDetail.vue');
...
var routes = [{ path: '/', component: _MovieList2.default }, { path: '/movie/:id', component: _MovieDetail2.default }];
...
},{"../components/MovieDetail.vue":11,"../components/MovieList.vue":12,"vue":9,"vue-router":4}]},{},[13]);
